...
export async function seedIfEmpty() {
  ...
  await db.items.bulkAdd([
    { name: "Tapal Danedar 200g", price: 540, emoji: "🍵", category: "grocery", description: "Premium Black Tea" },
    { name: "Lipton Yellow Label 190g", price: 520, emoji: "🍵", category: "grocery", description: "Black Tea" },
    { name: "Nestle MilkPak 1L", price: 300, emoji: "🥛", category: "dairy", description: "UHT Milk" },
    { name: "Olpers Milk 1L", price: 310, emoji: "🥛", category: "dairy", description: "UHT Milk" },
    { name: "Sunridge Chakki Atta 5kg", price: 1450, emoji: "🌾", category: "grocery", description: "Whole Wheat" },
    { name: "Daal Masoor 1kg", price: 320, emoji: "🥣", category: "grocery", description: "Loose Daal" },
    { name: "Daal Chana 1kg", price: 280, emoji: "🥣", category: "grocery", description: "Loose Daal" },
    { name: "Basmati Rice 1kg", price: 450, emoji: "🍚", category: "grocery", description: "Super Kernal" },
    { name: "Dalda Cooking Oil 1L", price: 620, emoji: "🛢️", category: "grocery", description: "Pouch" },
    { name: "Mezan Canola Oil 1L", price: 600, emoji: "🛢️", category: "grocery", description: "Pouch" },
    { name: "National Ketchup 800g", price: 420, emoji: "🍅", category: "grocery", description: "Tomato Ketchup" },
    { name: "Shangrila Chilli Garlic 800g", price: 450, emoji: "🌶️", category: "grocery", description: "Chilli Sauce" },
    { name: "Lifebuoy Soap 100g", price: 110, emoji: "🧼", category: "personal", description: "Red Bar" },
    { name: "Safeguard Soap 130g", price: 160, emoji: "🧼", category: "personal", description: "White Bar" },
    { name: "Surf Excel 1kg", price: 650, emoji: "👕", category: "household", description: "Washing Powder" },
    { name: "Ariel 500g", price: 340, emoji: "👕", category: "household", description: "Washing Powder" },
    { name: "Sunsilk Shampoo 180ml", price: 350, emoji: "🧴", category: "personal", description: "Black shine" },
    { name: "Colgate MaxFresh 120g", price: 250, emoji: "🦷", category: "personal", description: "Red gel" },
    { name: "Lays French Cheese (Large)", price: 100, emoji: "🥔", category: "snack", description: "Chips" },
    { name: "Kurkure Chutney Chaska", price: 50, emoji: "🌶️", category: "snack", description: "Snack" },
    { name: "Superbiscuit / Sooper", price: 40, emoji: "🍪", category: "snack", description: "Peak Freans" },
    { name: "Rio Biscuit", price: 30, emoji: "🍪", category: "snack", description: "Chocolate vanilla" },
    { name: "Coca Cola 1.5L", price: 180, emoji: "🥤", category: "beverage", description: "Cold Drink" },
    { name: "Sprite 1.5L", price: 180, emoji: "🥤", category: "beverage", description: "Cold Drink" },
    { name: "Fresh Dahi", price: 200, emoji: "🥣", category: "dairy", description: "Per kg" },
    { name: "Anda (Egg)", price: 30, emoji: "🥚", category: "dairy", description: "Per piece" },
    { name: "National Salt 800g", price: 60, emoji: "🧂", category: "grocery", description: "Iodized Salt" },
    { name: "Mortein Coil", price: 120, emoji: "🦟", category: "household", description: "Mosquito repellent" },
    { name: "Matchbox Bundle", price: 50, emoji: "🔥", category: "household", description: "10 boxes" },
  ]);
